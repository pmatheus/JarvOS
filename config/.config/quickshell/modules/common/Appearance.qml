...
Singleton {
    ...
    property real transparency: Config.options.appearance.transparency ? (m3colors.darkmode ? 0.0 : 0.0) : 0
    property real contentTransparency: Config.options?.appearance.transparency ? (m3colors.darkmode ? 0.5 : 0.5) : 0
    ...
    sizes: QtObject {
        ...
        property real searchWidthCollapsed: 320
        property real searchWidth: 520
